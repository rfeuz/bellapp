...
class ProfileInformation {
  static String name = 'Peter Miller';
  static int age = 43;
  static String CountryOfOrigin = 'America';
  static String Language = 'German';
<<<<<<< Updated upstream
  static String MyDiary = '-';
=======
  static String Location = 'Basel Seafood';
  static List<String> MyDiary = [
    'The people around me make me very happy',
    'Healty food and drinks!',
    'I heard a really good TedTalk',
    'I went to the park and it was absolutely stunning',
    'Just being in the nature',
    'Discovery of a new Song!!!', '', '', '', ''];
...
class Dates {
  static DateTime DateBefore = DateTime(2020, 1, 1);
...
class ChatBotAnswers {
  ...
  ['Let us visit a park, there is are always something new to discover',
